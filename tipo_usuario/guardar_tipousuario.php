...
if ($accion=="guardar") {
	...
	if ($objtusu->agregarTipoUsuario($descripcion)==true)
	{
		$objtusu=new clsTipoUsuario;
		$result=$objtusu->crearUsuarioBD($descripcion);
		$objtusu=new clsTipoUsuario;
		$result=$objtusu->consultarTipoUsuarioIdMaximo();
...
if ($accion=="modificar") 
{
	...
	$objtusu=new clsTipoUsuario;
	if ($objtusu->modificarTipoUsuario($cod,$descripcion)==true)
	{
...
<div class="block">
    ...
    <legend>Detalles de tipo de usuario</legend>
