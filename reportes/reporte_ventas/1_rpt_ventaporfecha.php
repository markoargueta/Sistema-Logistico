...
function enviarPDF()
{
	...
	window.open("1_rpt_pdf_ventaporfecha.php?fechaini="+fi+"&fechafin="+ff,'win2','status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');
return false;
...
function enviarPrinter()
{
	var fi=document.datos.fechaini.value;
	var ff=document.datos.fechafin.value;
	window.open("1_rpt_printer_ventaporfecha.php?fechaini="+fi+"&fechafin="+ff,'win2','status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');
return false;
...
?>
<form name="datos" action="1_rpt_ventaporfecha.php" method="post">
...
while($row=mysql_fetch_array($result)){
	...
	echo "<td width='5%' align='center'><a href=1_rpt_ventaporfecha_detalle.php?idventa=".$row["IdVenta"]." title='Ver Detalle'><img src='../../img/Iconfinder/search-16.png'></td>";
