...
$options = array(
				...
				'xOrientation'=>'center',
				'width'=>500,
				'cols'=>array('num'=>array('justification'=>'center', 'width'=>50), 'Descripcion'=>array('justification'=>'left', 'width'=>400),'IdCategoria'=>array('justification'=>'center'))
				
			);
$txttit="<b>SISTEMA DE VENTAS</b>";
$txtsubtit="Reporte de Categorias\n";
